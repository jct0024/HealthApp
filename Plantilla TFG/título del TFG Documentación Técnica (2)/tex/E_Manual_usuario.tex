...
\imagen{AddAlimento}{Pantalla de añadir plato (Versión 2.0)}
Si el usuario desea añadir un plato nuevo, debe pulsar en \textbf{“Añadir Alimento”} abajo a la izquierda de la ventana. Así, aparece una nueva ventana con hasta cuatro columnas para añadir en cada una de ellas los ingredientes que compongan cada comida:
\begin{itemize}
...
\imagen{ValidarAlimento}{Pantalla de validación de alimento (Versión 1.0)}
...
Si desea volver a la página de dietas diarias, pulse \textbf{“Volver al Inicio”}.
