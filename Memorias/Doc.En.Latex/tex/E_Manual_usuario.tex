...
\imagen{dropbox}{Descarga desde dropbox}
...
\begin{figure}
\centering
\includegraphics[scale=0.5]{PPEstilos}
...
\begin{figure}[b]
\centering
\includegraphics[scale=0.5]{cambiarEstilo}
...
\imagen{CONCARAS}{Resultados del botón refrescar (Versión 1.0)}
\imagen{nutriscore3}{Caliad Nutriscore}
\pagebreak
...
\subsubsection{Guía de errores, avisos e informes}
