...
def registrarse(hojaUsuarios):
    ...
    label.pack()
    containerDNI = tk.Frame(registro,bg='green').pack(fill=tk.X)
    containerNOM = tk.Frame(registro).pack(fill=tk.X)
    containerAPE = tk.Frame(registro).pack(fill=tk.X)
    containerPWD = tk.Frame(registro).pack(fill=tk.X)
    containerSEX = tk.Frame(registro).pack(fill=tk.X)
    containerEDA = tk.Frame(registro).pack(fill=tk.X)
    containerALT = tk.Frame(registro).pack(fill=tk.X)
    containerPES = tk.Frame(registro).pack(fill=tk.X)
    containerACT = tk.Frame(registro).pack(fill=tk.X)
    #containerPAT = tk.Frame(registro).pack(fill=tk.X)
    containerTIP = tk.Frame(registro).pack(fill=tk.X)
    containerBut = tk.Frame(registro).pack(fill=tk.X)
    containerERR = tk.Frame(registro).pack(fill=tk.X)
    ...
    var = tk.IntVar()
    tk.Radiobutton(containerSEX, text="Hombre",padx = 5, variable=var, value=1).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    tk.Radiobutton(containerSEX, text="Mujer",padx = 20, variable=var, value=2).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    
    label_Act = tk.Label(containerACT, text="Actividad: ",width=20,font=("bold", 10))
    label_Act.pack(side=tk.LEFT)
    varAct = tk.IntVar()
    tk.Radiobutton(containerACT, text="1 ",padx = 10, variable=varAct, value=1).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    tk.Radiobutton(containerACT, text="2 ",padx = 10, variable=varAct, value=2).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    tk.Radiobutton(containerACT, text="3 ",padx = 10, variable=varAct, value=3).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    tk.Radiobutton(containerACT, text="4 ",padx = 10, variable=varAct, value=4).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    
    label_3 = tk.Label(containerTIP, text="Tipo",width=20,font=("bold", 10))
    label_3.pack(side=tk.LEFT)
    varTipo = tk.IntVar()
    tk.Radiobutton(containerTIP, text="bajar",padx = 5, variable=varTipo, value=1).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    tk.Radiobutton(containerTIP, text="mantener",padx = 20, variable=varTipo, value=2).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    tk.Radiobutton(containerTIP, text="subir",padx = 20, variable=varTipo, value=3).pack(expand=1,side=tk.LEFT,fill=tk.Y)
    '''
    ...
    buttonEnviar = tk.Button(containerBut, text='Aceptar y Guardar',command=partial(ab.NuevoUsuario,registro,hojaUsuarios,entry_Dni, entry_Nom,entry_Ape,entry_Pwd, var,entry_Eda,entry_Alt,entry_Pes,varAct, varTipo,label_Err),relief=tk.GROOVE).pack(fill=tk.X)
    
    button = tk.Button(containerBut, text="Cancelar",command=lambda:registro.destroy,relief=tk.GROOVE).pack(fill=tk.X)
    label_Err.pack()
    registro.mainloop(); 